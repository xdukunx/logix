...
- [ ] **G. Dashboard: modularize, add Device Registry / Detail / Sync Health, add loading/empty/error/offline/stale states** — Med / High / Low. *(deferred — separable UI effort, no connection to the wizard/README work in H/I)*
